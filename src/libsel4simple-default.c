...
#define INIT_CAP_BASE_RANGE (seL4_CapInitThreadASIDPool)
        ...
        #define INIT_CAP_TOP_RANGE (seL4_CapRunqueue - seL4_CapIOPort + INIT_CAP_BASE_RANGE)
    #else
        #define INIT_CAP_TOP_RANGE (seL4_CapRunqueue - seL4_CapIOSpace + INIT_CAP_BASE_RANGE)
    #endif
#elif defined(CONFIG_ARCH_IA32)
    #if defined(CONFIG_IOMMU)
        #define INIT_CAP_TOP_RANGE (seL4_CapRunqueue - seL4_CapInitThreadASIDPool + INIT_CAP_BASE_RANGE)
    #else
        #define INIT_CAP_TOP_RANGE (seL4_CapRunqueue - seL4_CapInitThreadASIDPool - 1 + INIT_CAP_BASE_RANGE)
    #endif
#endif
